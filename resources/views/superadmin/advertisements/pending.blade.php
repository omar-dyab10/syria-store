            ...
            @foreach ($advertisements as $advertisement)
                <div class="ad-card pending">
                    ...
                    <div class="ad-actions">
                        <a href="{{ route('super-admin.advertisements.approve',$advertisement) }}" class="btn-approve">
                            <i class="fas fa-check"></i> موافقة
                        </a>
                        <a href="{{ route('super-admin.advertisements.reject',$advertisement) }}" class="btn-reject">
